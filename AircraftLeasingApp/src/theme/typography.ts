...
export const T: Record<string, TextStyle> = {
  hero:      { fontSize: 32, fontWeight: '800', color: C.white, letterSpacing: -1 },
  ...
  num:       { fontSize: 36, fontWeight: '800', color: C.white, letterSpacing: -1 },
  numMd:     { fontSize: 24, fontWeight: '800', color: C.white },
};
